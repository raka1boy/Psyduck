...
# !!! Main.UserApp is configured as an alias for Main.Kursovich and you might encounter it in some tests
using Main.Kursovich, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Kursovich tests" begin
  @includetests ARGS
end
